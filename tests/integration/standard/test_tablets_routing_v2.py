...
class TestTabletsRoutingV2Integration:
    ...
    def _create_schema(cls, session):
        ...
        # use QUORUM/LOCAL_QUORUM (strong_consistency/modification_statement.cc).
        # The session default is LOCAL_ONE, so request LOCAL_QUORUM for these
        # inserts; it propagates to every statement bound from this prepared one.
