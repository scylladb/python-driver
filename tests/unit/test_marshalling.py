...
class UnmarshalTest(unittest.TestCase):
    def test_unmarshalling(self):
        for serializedval, valtype, nativeval in marshalled_value_pairs:
            ...
            whatwegot = unmarshaller(3).from_binary(serializedval)
    ...
    def test_marshalling(self):
        for serializedval, valtype, nativeval in marshalled_value_pairs:
            ...
            whatwegot = marshaller(3).to_binary(nativeval)
    ...
    def test_date(self):
        ...
        assert DateType(3).from_binary(DateType(3).to_binary(date(2015, 11, 2))) == datetime(2015, 11, 2)
