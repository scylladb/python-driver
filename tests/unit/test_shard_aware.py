...
class TestShardAware(unittest.TestCase):
    ...
    def test_shard_aware_reconnection_policy_no_delay(self):
        ...
        self._test_shard_aware_reconnection_policy(4, NoDelayShardConnectionBackoffPolicy(), 4, 4)
    ...
    def test_shard_aware_reconnection_policy_delay(self):
        ...
        self._test_shard_aware_reconnection_policy(
            ...
            LimitedConcurrencyShardConnectionBackoffPolicy(
                ShardConnectionBackoffScope.Cluster,
                ConstantReconnectionPolicy(0.1),
                1
            ), 1, 4)

    def _test_shard_aware_reconnection_policy(self, shard_count, shard_connection_backoff_policy, expected_count, expected_after):
        """
        ...
        class MockSession(MagicMock):
            ...
            def __init__(self, is_ssl=False, *args, **kwargs):
                ...
                self.shard_connection_backoff_scheduler = shard_connection_backoff_policy.new_scheduler(self)
                self.futures = []
