...
class TypeTests(unittest.TestCase):
    ...
    def test_datetype(self):
        ...
        deserialized = DateType.deserialize(int64_pack(ts_ms))
        ...
        assert int64_unpack(DateType.serialize(deserialized)) == ts_ms

        # Negative large timestamp: 1600-01-01 00:00:00.001 UTC
        ts_ms_neg = -11676096000000 + 1  # -11676095999999
        deserialized_neg = DateType.deserialize(int64_pack(ts_ms_neg))
        assert deserialized_neg == datetime.datetime(1600, 1, 1, 0, 0, 0, 1000)
        assert int64_unpack(DateType.serialize(deserialized_neg)) == ts_ms_neg
