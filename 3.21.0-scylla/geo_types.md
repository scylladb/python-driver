...
some simple representative types in `cassandra.util` for inserting and retrieving data:
...
Queries returning geometric types return the `dse.util` types. Note that these can easily be used to construct
