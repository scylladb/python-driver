...
* If a consistency level is not specified for an execution profile or query, then [`ConsistencyLevel.LOCAL_QUORUM`](api/cassandra.md#cassandra.ConsistencyLevel.LOCAL_QUORUM) will be used as the default.

## Limitations

### Event loops

Evenlet isn’t yet supported for python 3.7+ due to an [issue in Eventlet](https://github.com/eventlet/eventlet/issues/526).
