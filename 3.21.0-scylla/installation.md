...
<a id="installation-datastax-graph"></a>
...
See [DataStax Graph Fluent API](graph_fluent.md) for more details about this API.
...
The driver has built-in support for capturing `Cluster.metrics` about
...
[requirements.txt](https://github.com/datastax/python-driver/blob/master/requirements.txt).
