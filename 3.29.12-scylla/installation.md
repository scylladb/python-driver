...
It should print something like “3.29.12”.
...
See the [Security](https://python-driver.docs.scylladb.com/stable/security.md#security) section for details on configuring SSL.
