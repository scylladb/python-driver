...
[`connection.EndPoint`](https://python-driver.docs.scylladb.com/stable/api/cassandra/connection.md#cassandra.connection.EndPoint) instance.

Defaults to loopback interface.

Note: When using [`DCAwareRoundRobinPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.DCAwareRoundRobinPolicy) with no explicit
...
See [`ProtocolVersion`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ProtocolVersion) for more information about versions.
...
be an instance of a subclass of [`AuthProvider`](https://python-driver.docs.scylladb.com/stable/api/cassandra/auth.md#cassandra.auth.AuthProvider),
such as [`PlainTextAuthProvider`](https://python-driver.docs.scylladb.com/stable/api/cassandra/auth.md#cassandra.auth.PlainTextAuthProvider).

When not using authentication, this should be left as `None`.

#### load_balancing_policy

An instance of [`policies.LoadBalancingPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.LoadBalancingPolicy) or
one of its subclasses.

#### Versionchanged
Changed in version 2.6.0.

Defaults to [`TokenAwarePolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.TokenAwarePolicy) ([`DCAwareRoundRobinPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.DCAwareRoundRobinPolicy)).
when using CPython (where the murmur3 extension is available). [`DCAwareRoundRobinPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.DCAwareRoundRobinPolicy)
otherwise. Default local DC will be chosen from contact points.

**Please see** [`DCAwareRoundRobinPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.DCAwareRoundRobinPolicy) **for a discussion on default behavior with respect to
DC locality and remote nodes.**

#### reconnection_policy *= <cassandra.policies.ExponentialReconnectionPolicy object>*

An instance of [`policies.ReconnectionPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.ReconnectionPolicy). Defaults to an instance
of [`ExponentialReconnectionPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.ExponentialReconnectionPolicy) with a base delay of one second and
a max delay of ten minutes.

#### default_retry_policy *= <cassandra.policies.RetryPolicy object>*

A default [`policies.RetryPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.RetryPolicy) instance to use for all
[`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) objects which do not have a [`retry_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.retry_policy)
explicitly set.

#### conviction_policy_factory *= <class 'cassandra.policies.SimpleConvictionPolicy'>*

A factory function which creates instances of
[`policies.ConvictionPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.ConvictionPolicy).  Defaults to
[`policies.SimpleConvictionPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.SimpleConvictionPolicy).

#### address_translator *= <cassandra.policies.IdentityTranslator object>*

[`policies.AddressTranslator`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.AddressTranslator) instance to be used in translating server node addresses
...
will be an instance of [`Metrics`](https://python-driver.docs.scylladb.com/stable/api/cassandra/metrics.md#cassandra.metrics.Metrics).

#### metrics *= None*

An instance of [`cassandra.metrics.Metrics`](https://python-driver.docs.scylladb.com/stable/api/cassandra/metrics.md#cassandra.metrics.Metrics) if [`metrics_enabled`](#cassandra.cluster.Cluster.metrics_enabled) is
`True`, else `None`.
...
A [`SSLSessionCache`](https://python-driver.docs.scylladb.com/stable/api/cassandra/ssl-session-cache.md#cassandra.ssl_session_cache.SSLSessionCache) shared by every
...
One is created on first use when [`ssl_context`](#cassandra.cluster.Cluster.ssl_context) is set.
Nothing is settled before then: this answers against whatever
[`ssl_context`](#cassandra.cluster.Cluster.ssl_context) and [`connection_class`](#cassandra.cluster.Cluster.connection_class) are in
...
caller’s: [`shutdown()`](#cassandra.cluster.Cluster.shutdown) leaves its entries alone, so several
...
[`max_size`](https://python-driver.docs.scylladb.com/stable/api/cassandra/ssl-session-cache.md#cassandra.ssl_session_cache.SSLSessionCache.max_size); call
[`clear()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/ssl-session-cache.md#cassandra.ssl_session_cache.SSLSessionCache.clear) to release
them.

Assigning it is honoured whenever, and a cache that cannot be used reads
back as `None` rather than being left to fill with nothing.  Why
it cannot be used is said once, by [`connect()`](#cassandra.cluster.Cluster.connect), which is
the only place that says it: a cache assigned after that reads back as
`None` just the same, without a second word about it.

Pass `ssl_session_cache=None` to [`Cluster`](#cassandra.cluster.Cluster) to turn resumption
...
[Security](https://python-driver.docs.scylladb.com/stable/security.md#security).  Where any of that is missing no cache is created and
this reads as `None`, and connections handshake in full as they
...
An instance of [`cassandra.metadata.Metadata`](https://python-driver.docs.scylladb.com/stable/api/cassandra/metadata.md#cassandra.metadata.Metadata).
...
* [`cassandra.io.asyncorereactor.AsyncoreConnection`](https://python-driver.docs.scylladb.com/stable/api/cassandra/io/asyncorereactor.md#cassandra.io.asyncorereactor.AsyncoreConnection)
* [`cassandra.io.libevreactor.LibevConnection`](https://python-driver.docs.scylladb.com/stable/api/cassandra/io/libevreactor.md#cassandra.io.libevreactor.LibevConnection)
* EXPERIMENTAL: [`cassandra.io.asyncioreactor.AsyncioConnection`](https://python-driver.docs.scylladb.com/stable/api/cassandra/io/asyncioreactor.md#cassandra.io.asyncioreactor.AsyncioConnection)
...
[`MonotonicTimestampGenerator`](https://python-driver.docs.scylladb.com/stable/api/cassandra/timestamps.md#cassandra.timestamps.MonotonicTimestampGenerator).
...
An [`EndPointFactory`](https://python-driver.docs.scylladb.com/stable/api/cassandra/connection.md#cassandra.connection.EndPointFactory) instance to use internally when creating
...
`function` is a [`cassandra.UserFunctionDescriptor`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.UserFunctionDescriptor).
...
`aggregate` is a [`cassandra.UserAggregateDescriptor`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.UserAggregateDescriptor).
...
keyspace, including `None`. Other sessions may use fallback only
...
[`InvalidRequest`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.InvalidRequest).

An explicit `USE` statement – including the one
[`Session.set_keyspace()`](#cassandra.cluster.Session.set_keyspace) executes – is rejected with
[`InvalidRequest`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.InvalidRequest) on the fallback path, because it would change the
...
[`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel) used when not specified on a [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement).

#### load_balancing_policy *= None*

An instance of [`policies.LoadBalancingPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.LoadBalancingPolicy) or one of its subclasses.
...
An instance of [`policies.RetryPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.RetryPolicy) instance used when [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) objects do not have a
[`retry_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.retry_policy) explicitly set.

Defaults to [`RetryPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.RetryPolicy) if not specified

#### serial_consistency_level *= None*

Serial [`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel) used when not specified on a [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) (for LWT conditional statements).
...
- [`cassandra.query.tuple_factory()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.tuple_factory) - return a result row as a tuple
- [`cassandra.query.named_tuple_factory()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.named_tuple_factory) - return a result row as a named tuple
- [`cassandra.query.dict_factory()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.dict_factory) - return a result row as a dict
- [`cassandra.query.ordered_dict_factory()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.ordered_dict_factory) - return a result row as an OrderedDict

#### speculative_execution_policy *= None*

An instance of [`policies.SpeculativeExecutionPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.SpeculativeExecutionPolicy)
...
See [`Statement.fetch_size`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.fetch_size) or [`Session.default_fetch_size`](#cassandra.cluster.Session.default_fetch_size) for configuring normal paging.
...
Use this as the key in [Cluster(execution_profiles)](https://python-driver.docs.scylladb.com/stable/execution-profiles.md)
...
[`consistency_level`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.consistency_level) on individual statements.
...
this session.  This default may be overridden by setting the
[`serial_consistency_level`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.serial_consistency_level) on individual statements.
...
[`Statement.fetch_size`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.fetch_size).
...
[`MonotonicTimestampGenerator`](https://python-driver.docs.scylladb.com/stable/api/cassandra/timestamps.md#cassandra.timestamps.MonotonicTimestampGenerator) is created for
...
A [`Encoder`](https://python-driver.docs.scylladb.com/stable/api/cassandra/encoder.md#cassandra.encoder.Encoder) instance that will be used when
...
fit.  Methods of [`Encoder`](https://python-driver.docs.scylladb.com/stable/api/cassandra/encoder.md#cassandra.encoder.Encoder) should be used for mapping
...
When compiled with Cython, there are also built-in faster alternatives. See [Faster Deserialization](https://python-driver.docs.scylladb.com/stable/api/cassandra/protocol.md#faster-deser)
...
query may be a query string or an instance of [`cassandra.query.Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement).
...
which an [`OperationTimedOut`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.OperationTimedOut) exception will be raised if the query
...
custom_payload is a [Custom Payloads](https://python-driver.docs.scylladb.com/stable/api/cassandra/protocol.md#custom-payload) dict to be passed to the server.
...
host is the [`cassandra.pool.Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host) that should handle the query. If the host specified is down or
...
Prepares a query string, returning a [`PreparedStatement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.PreparedStatement)
...
message. See [Custom Payloads](https://python-driver.docs.scylladb.com/stable/api/cassandra/protocol.md#custom-payload).
...
Raises [`InvalidRequest`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.InvalidRequest) when the session uses the
control-connection fallback path (see
[`ControlConnectionQueryFallback`](#cassandra.cluster.ControlConnectionQueryFallback)), where the keyspace of the
...
The [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) instance that is being executed through this
...
If the timeout is exceeded, an [`cassandra.OperationTimedOut`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.OperationTimedOut) will be raised.
This is a client-side timeout. For more information
about server-side coordinator timeouts, see [`policies.RetryPolicy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/policies.md#cassandra.policies.RetryPolicy).
...
[`cassandra.query.TraceUnavailable`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.TraceUnavailable) will be raised.
...
* **Returns:**
  [Custom Payloads](https://python-driver.docs.scylladb.com/stable/api/cassandra/protocol.md#custom-payload).
...
a [`query.BatchStatement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.BatchStatement) containing LWT. In the latter case either all the batch
succeeds or fails.
