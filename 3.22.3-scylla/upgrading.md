...
See [`fluent`](api/cassandra/datastax/graph/fluent/index.md#module-cassandra.datastax.graph.fluent).
...
* Use [`DefaultLoadBalancingPolicy`](api/cassandra/policies.md#cassandra.policies.DefaultLoadBalancingPolicy) instead of DSELoadBalancingPolicy.
...
[PYTHON-368](https://datastax-oss.atlassian.net/browse/PYTHON-368)
...
For backward compatibility, `ResultSet` supports indexing. When
...
[PYTHON-318](https://datastax-oss.atlassian.net/browse/PYTHON-318)
...
[PYTHON-178](https://datastax-oss.atlassian.net/browse/PYTHON-178Cassadfasdf)

Previously, `BoundStatement.bind()` would raise if a mapping
...
[PYTHON-385](https://datastax-oss.atlassian.net/browse/PYTHON-385)
...
internal `util.SortedSet` for all `set` results. The class implements
...
[PYTHON-276](https://datastax-oss.atlassian.net/browse/PYTHON-276), [PYTHON-408](https://datastax-oss.atlassian.net/browse/PYTHON-408), [PYTHON-400](https://datastax-oss.atlassian.net/browse/PYTHON-400), [PYTHON-422](https://datastax-oss.atlassian.net/browse/PYTHON-422)
...
The present API is documented: [`cassandra.metadata`](api/cassandra/metadata.md#module-cassandra.metadata). Changes highlighted below:
...
[PYTHON-292](https://datastax-oss.atlassian.net/browse/PYTHON-292)

* `ResponseFuture.result` timeout parameter is removed, use `Session.execute` timeout instead ([031ebb0](https://github.com/datastax/python-driver/commit/031ebb0))
* `Cluster.refresh_schema` removed, use `Cluster.refresh_*_metadata` instead ([419fcdf](https://github.com/datastax/python-driver/commit/419fcdf))
* `Cluster.submit_schema_refresh` removed ([574266d](https://github.com/datastax/python-driver/commit/574266d))
* `cqltypes` time/date functions removed, use `util` entry points instead ([bb984ee](https://github.com/datastax/python-driver/commit/bb984ee))
* `decoder` module removed ([e16a073](https://github.com/datastax/python-driver/commit/e16a073))
* `TableMetadata.keyspace` attribute replaced with `keyspace_name` ([cc94073](https://github.com/datastax/python-driver/commit/cc94073))
* `cqlengine.columns.TimeUUID.from_datetime` removed, use `util` variant instead ([96489cc](https://github.com/datastax/python-driver/commit/96489cc))
* `cqlengine.columns.Float(double_precision)` parameter removed, use `columns.Double` instead ([a2d3a98](https://github.com/datastax/python-driver/commit/a2d3a98))
* `cqlengine` keyspace management functions are removed in favor of the strategy-specific entry points ([4bd5909](https://github.com/datastax/python-driver/commit/4bd5909))
* `cqlengine.Model.__polymorphic_*__` attributes removed, use `__discriminator*` attributes instead ([9d98c8e](https://github.com/datastax/python-driver/commit/9d98c8e))
* `cqlengine.statements` will no longer warn about list list prepend behavior ([79efe97](https://github.com/datastax/python-driver/commit/79efe97))
...
See [User Defined Types](user_defined_types.md#udts) for more details.
...
See [Type Conversions](getting_started.md#type-conversions) for the table of default CQL literal conversions.
...
When `protocol_version` is set to 3 or higher, the driver
will automatically use client-side timestamps with microsecond precision
unless `Session.use_client_timestamp` is changed to `False`.
...
explicitly set the `protocol_version` to 1:
...
See [Paging Large Queries](query_paging.md#query-paging) for full details.

### Protocol-Level Batch Statements

With version 1 of the native protocol, batching of statements required
using a [BATCH cql query](http://cassandra.apache.org/doc/cql3/CQL-3.0.html#batchStmt).
...
See the section on [Security](security.md#security) for details and examples.

### Lightweight Transactions

[Lightweight transactions](http://www.datastax.com/dev/blog/lightweight-transactions-in-cassandra-2-0) are another new feature.  To use lightweight transactions, add `IF` clauses
...
on your `Cluster` objects when you are through with them.
...
* [`cassandra.decoder.tuple_factory`](api/cassandra/decoder.md#cassandra.decoder.tuple_factory) has moved to
  `cassandra.query.tuple_factory`
* [`cassandra.decoder.named_tuple_factory`](api/cassandra/decoder.md#cassandra.decoder.named_tuple_factory) has moved to
  `cassandra.query.named_tuple_factory`
* [`cassandra.decoder.dict_factory`](api/cassandra/decoder.md#cassandra.decoder.dict_factory) has moved to
  `cassandra.query.dict_factory`
* [`cassandra.decoder.ordered_dict_factory`](api/cassandra/decoder.md#cassandra.decoder.ordered_dict_factory) has moved to
