...
Run:
    python benchmarks/micro/bench_checksumming_inline.py
"""
...
from cassandra.protocol import _CHECKSUMMING_MIN_VERSION, _CHECKSUMMING_MAX_VERSION_EXCLUSIVE
...
def bench():
    ...
    def via_inline():
        return _CHECKSUMMING_MIN_VERSION <= protocol_version < _CHECKSUMMING_MAX_VERSION_EXCLUSIVE
