...
from cassandra.cqltypes import FloatType, DoubleType, Int32Type, LongType, ShortType, VectorType
from cassandra.marshal import float_pack, double_pack, int32_pack, int64_pack, int16_pack


def create_test_data(vector_size, element_type, protocol_version=5):
...
def run_benchmark_suite(vector_size, element_type, type_name, iterations=10000):
    ...
    typename = element_type.typename
