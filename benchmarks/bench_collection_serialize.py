...
Measures end-to-end serialize_safe performance for List, Set, Map, Tuple, and
UserType with varying collection sizes.
"""
...
def main():
    ...
    print("\nSetType.serialize (set of int32):")
    _, r = run_bench(
        "10 elements", SetOfInt.serialize, (set_10, PROTOCOL_VERSION), N_SMALL
    )
    results["set_10"] = r
    _, r = run_bench(
        "100 elements", SetOfInt.serialize, (set_100, PROTOCOL_VERSION), N_MED
    )
    results["set_100"] = r
