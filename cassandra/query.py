...
from cassandra.util import unix_time_from_uuid1, add_timeout_to_query
    ...
    def populate(self, max_wait=2.0, wait_for_complete=True, query_cl=None):
        ...
        while True:
            ...
            session_results = self._execute(
                SimpleStatement(add_timeout_to_query(self._SELECT_SESSIONS_FORMAT, metadata_request_timeout), consistency_level=query_cl), (self.trace_id,), time_spent, max_wait)
            ...
            event_results = self._execute(
                SimpleStatement(add_timeout_to_query(self._SELECT_EVENTS_FORMAT, metadata_request_timeout),
