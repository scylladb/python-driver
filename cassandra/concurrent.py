...
class ConcurrentExecutorListResults(_ConcurrentExecutor):
    ...
    def _submitter_loop(self):
        ...
        try:
            ...
            # than StopIteration out of next(enum_stmts)) would otherwise
            # kill this thread silently -- and since this thread is the
            # only thing that ever advances _current/_exec_count or wakes
