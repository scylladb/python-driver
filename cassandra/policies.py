...
class TokenAwarePolicy(LoadBalancingPolicy):
    ...
    def make_query_plan(self, working_keyspace=None, query=None):
        ...
        if tablet is not None:
            ...
            if (ks_meta is not None and ks_meta._consistency_mode is _ConsistencyMode.GLOBAL
                ...
                #       level here. This can be equal to None, in which case we
                #       should fall back to the execution profile's consistency
                #       level. Unfortunately, it's non-trivial to get access to
                #       it here.
