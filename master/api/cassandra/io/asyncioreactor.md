...
TLS session resumption ([`Cluster.ssl_session_cache`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.ssl_session_cache)) is not
