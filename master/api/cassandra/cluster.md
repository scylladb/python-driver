...
A [`SSLSessionCache`](https://python-driver.docs.scylladb.com/master/api/cassandra/ssl-session-cache.md#cassandra.ssl_session_cache.SSLSessionCache) shared by every
...
[`max_size`](https://python-driver.docs.scylladb.com/master/api/cassandra/ssl-session-cache.md#cassandra.ssl_session_cache.SSLSessionCache.max_size); call
[`clear()`](https://python-driver.docs.scylladb.com/master/api/cassandra/ssl-session-cache.md#cassandra.ssl_session_cache.SSLSessionCache.clear) to release
them.
...
[Security](https://python-driver.docs.scylladb.com/master/security.md#security).  Where any of that is missing no cache is created and
...
[`InvalidRequest`](https://python-driver.docs.scylladb.com/master/api/cassandra.md#cassandra.InvalidRequest).
...
[`InvalidRequest`](https://python-driver.docs.scylladb.com/master/api/cassandra.md#cassandra.InvalidRequest) on the fallback path, because it would change the
...
Raises [`InvalidRequest`](https://python-driver.docs.scylladb.com/master/api/cassandra.md#cassandra.InvalidRequest) when the session uses the
