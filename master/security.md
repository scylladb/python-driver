...
[`Cluster.ssl_context`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.ssl_context) is set, the driver caches the TLS session each
...
[`Cluster.ssl_options`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.ssl_options)-only configuration below, since each of those
...
[`Cluster.ssl_session_cache`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.ssl_session_cache) reads as `None`; asking for one anyway is
reported when [`Cluster.connect()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.connect) is called. To turn resumption off, or to
size the cache or share it between clusters, see
[`Cluster.ssl_session_cache`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.ssl_session_cache):
