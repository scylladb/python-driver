...
responds that authentication is successful (or an [`AuthenticationFailed`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.AuthenticationFailed)
is raised).
