...
Returns a measure of how remote a [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host) is in
...
policy with a set of [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host) instances before its
first use.  The cluster parameter is an instance of
[`Cluster`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster).

#### make_query_plan(working_keyspace=None, query=None)

Given a [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) instance, return a iterable
of [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host) instances which should be queried in that
...
as set through [`Session.set_keyspace()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Session.set_keyspace) or with a `USE`
statement.
...
a local_dc based on the first host among [`Cluster.contact_points`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster.contact_points)
...
### *class* cassandra.policies.TokenAwarePolicy(child_policy, shuffle_replicas=True)
...
by the child policy) based on the [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement)’s
[`routing_key`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.routing_key). If [`shuffle_replicas`](#cassandra.policies.TokenAwarePolicy.shuffle_replicas) is
...
If no [`routing_key`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.routing_key) is set on the query, the child
...
* **Parameters:**
  ...
  * **predicate** – a one-parameter function that takes a [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host).
    If it returns a falsy value, the [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host) will
...
A predicate, set on object initialization, that takes a [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host)
and returns a value. If the value is falsy, the [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host) is
...
*Note:* `contact_points` provided while creating the [`Cluster`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster) instance are not
...
host is an instance of [`Host`](https://python-driver.docs.scylladb.com/stable/api/cassandra/pool.md#cassandra.pool.Host).
...
[`Cluster.default_retry_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster.default_retry_policy) attribute to an instance of this
class or one of its subclasses.

To specify a retry policy per query, set the [`Statement.retry_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.retry_policy)
...
as [`RETRY`](#cassandra.policies.RetryPolicy.RETRY)) and a [`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel) to retry the
operation at or `None` to keep the same consistency level.

query is the [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) that timed out.

consistency is the [`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel) that the operation was
attempted at.
...
replicas are too low to meet the requested [`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel).
This means that the read or write operation was never forwarded to
any replicas.

query is the [`Statement`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement) that failed.
...
there are cases (documented below) where a read at [`QUORUM`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel.QUORUM)
*may not* see a preceding write at [`QUORUM`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel.QUORUM). Do not use this
