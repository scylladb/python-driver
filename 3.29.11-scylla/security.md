...
[`TwistedConnection`](https://python-driver.docs.scylladb.com/stable/api/cassandra/io/twistedreactor.md#cassandra.io.twistedreactor.TwistedConnection) or `EventletConnection`, you must pass a
