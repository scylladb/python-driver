...
Execution profiles can inherit from [`cluster.ExecutionProfile`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.ExecutionProfile), and currently provide the following options,
previously input from the noted attributes:

- load_balancing_policy - [`Cluster.load_balancing_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster.load_balancing_policy)
- request_timeout - [`Session.default_timeout`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Session.default_timeout), optional [`Session.execute()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Session.execute) parameter
- retry_policy - [`Cluster.default_retry_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster.default_retry_policy), optional [`Statement.retry_policy`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.retry_policy) attribute
- consistency_level - [`Session.default_consistency_level`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Session.default_consistency_level), optional [`Statement.consistency_level`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.consistency_level) attribute
- serial_consistency_level - [`Session.default_serial_consistency_level`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Session.default_serial_consistency_level), optional [`Statement.serial_consistency_level`](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.Statement.serial_consistency_level) attribute
- row_factory - [`Session.row_factory`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Session.row_factory) attribute

When using the new API, these parameters can be defined by instances of [`cluster.ExecutionProfile`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.ExecutionProfile).
...
present. To override the default, specify a policy with the [`EXEC_PROFILE_DEFAULT`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.EXEC_PROFILE_DEFAULT) key.
...
See [`Cluster.add_execution_profile()`](https://python-driver.docs.scylladb.com/stable/api/cassandra/cluster.md#cassandra.cluster.Cluster.add_execution_profile) for details and optional parameters.
