...
Sets the consistency level for the operation. See [`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel).
...
See [Retrieving objects with filters](https://python-driver.docs.scylladb.com/stable/cqlengine/queryset.md#retrieving-objects-with-filters)
...
See [Batch Queries](https://python-driver.docs.scylladb.com/stable/cqlengine/batches.md) for more details.

* **Parameters:**
  * **batch_type** ([*BatchType*](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.BatchType) *,* *str* *or* *None*) – (optional) One of batch type values available through BatchType enum
  * **timestamp** ([*datetime*](https://python-driver.docs.scylladb.com/stable/api/cassandra/query.md#cassandra.query.TraceEvent.datetime) *or* *timedelta* *or* *None*) – (optional) A datetime or timedelta object with desired timestamp to be applied
    to the batch conditional.
  * **consistency** (The [`ConsistencyLevel`](https://python-driver.docs.scylladb.com/stable/api/cassandra.md#cassandra.ConsistencyLevel) to be used for the batch query, or None.) – (optional) One of consistency values (“ANY”, “ONE”, “QUORUM” etc)
